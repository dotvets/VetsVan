...
app.get('/admin/rbac-client.js',(_req,res)=>res.sendFile(path.join(__dirname,'..','admin','rbac-client.js')));
...
// Dedicated indexable booking URLs. Reuse the single existing booking UI and logic.
